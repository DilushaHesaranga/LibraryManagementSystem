const RECIPES = [
    // Vegan (5)
    {
      id:'v1', title:'Herby Chickpea Salad', category:'Vegan', time:10, image:'./images/recipes/chickpea-salad-min.png',
    ...
    { id:'v2', title:'Avocado Toast', category:'Vegan', time:8, image:'./images/recipes/avocado-toast-min.png',
    ...
    { id:'v3', title:'Mango Chia Pudding', category:'Vegan', time:5, image:'./images/recipes/mango-chia-min.png',
    ...
    { id:'v4', title:'Quinoa Veggie Stir-Fry', category:'Vegan', time:15, image:'./images/recipes/quinoa-stirfry-min.png',
    ...
    { id:'v5', title:'Red Lentil Soup', category:'Vegan', time:15, image:'./images/recipes/lentil-soup-min.png',
    ...
    // High Protein (5)
    { id:'hp1', title:'Greek Yogurt Power Bowl', category:'High Protein', time:5, image:'./images/recipes/yogurt-bowl-min.png',
    ...
    { id:'hp2', title:'Chicken Salad Cups', category:'High Protein', time:12, image:'./images/recipes/chicken-salad-min.png',
    ...
    { id:'hp3', title:'Egg & Spinach Scramble', category:'High Protein', time:10, image:'./images/recipes/egg-spinach-min.png',
    ...
    { id:'hp4', title:'Tuna Lettuce Wraps', category:'High Protein', time:8, image:'./images/recipes/tuna-wraps-min.png',
    ...
    { id:'hp5', title:'Cottage-Cheese Pancakes', category:'High Protein', time:15, image:'./images/recipes/cottage-pancakes-min.png',
    ...
    // Gluten Free (5)
    { id:'gf1', title:'Zucchini Noodles Pesto', category:'Gluten Free', time:12, image:'./images/recipes/zoodles-min.png',
    ...
    { id:'gf2', title:'Grilled Salmon & Veg', category:'Gluten Free', time:15, image:'./images/recipes/salmon-veg-min.png',
    ...
    { id:'gf3', title:'Stuffed Bell Peppers', category:'Gluten Free', time:15, image:'./images/recipes/stuffed-peppers-min.png',
    ...
    { id:'gf4', title:'Sweet Potato Hash', category:'Gluten Free', time:15, image:'./images/recipes/sweet-potato-hash-min.png',
    ...
    { id:'gf5', title:'Coconut Rice & Beans', category:'Gluten Free', time:15, image:'./images/recipes/coconut-rice-beans-min.png',
    ...
    // 15-minute meals (5)
    { id:'q1', title:'Caprese Omelette', category:'15-minute meals', time:10, image:'./images/recipes/caprese-omelette-min.png',
    ...
    { id:'q2', title:'PB Banana Smoothie', category:'15-minute meals', time:5, image:'./images/recipes/pb-smoothie-min.png',
    ...
    { id:'q3', title:'Quick Shrimp Stir-Fry', category:'15-minute meals', time:12, image:'./images/recipes/shrimp-stirfry-min.png',
    ...
    { id:'q4', title:'Hummus Veg Wrap', category:'15-minute meals', time:8, image:'./images/recipes/hummus-wrap-min.png',
    ...
    { id:'q5', title:'Tomato Basil Pasta (quick)', category:'15-minute meals', time:15, image:'./images/recipes/quick-pasta-min.png',
